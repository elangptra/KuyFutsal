  ...
  return (
    <>
      <div className="w-full mt-[-80px]">
        ...
        <h1 className="lg:text-3xl md:text-2xl sm:text-md font-semibold italic absolute lg:top-[220px] md:top-[150px] sm:top-[100px] lg:left-[250px] md:left-[100px] sm:left-[120px] text-white ">
